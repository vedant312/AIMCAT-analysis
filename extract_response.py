...
def extract_answer_strings():
    ...
    base_url_template = "https://www.time4education.com/moodle/aimcatsolutions/get_ansstr.asp?tno={number}&area={section}&id=DRCAB5A329"
    start_number = 2625
    end_number = 2601  # Inclusive
    sections = ["VARC", "DILR", "QA"]
    output_filename = "vedant_response.json"
